...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "_v-dd2ece52/resize-bar.vue"
  if (!module.hot.data) {
...
var _coreImageXhr = __webpack_require__(61);

var _coreImageXhr2 = _interopRequireDefault(_coreImageXhr);

var _loadingGif = __webpack_require__(22);

var _loadingGif2 = _interopRequireDefault(_loadingGif);

var _canvasHelper = __webpack_require__(20);
  ...
  methods: {
    ...
    __initImage: function __initImage(src) {
      ...
      pic.onload = function () {
        ...
        _canvasHelper2.default.init(src, function (src) {
    ...
    doRotate: function doRotate(e) {
      ...
      return _canvasHelper2.default.rotate(targetImage, 1, function (src) {
        self.__initImage(src);
      });
    },
    ...
    doPreview: function doPreview(e) {
      var self = this;
      var cropBox = this.$refs.cropBox;
      self.__setData('crop');
      if (this.crop === 'local') {
...
var _drag2 = __webpack_require__(21);
...
exports.default = {
  ...
  methods: {
    ...
    rotateImage: function rotateImage(degress) {
      ...
      var data = _canvasHelper2.default.rotate2(this.originSrc, degress, function (data, w, h) {
...
module.exports = "\n<div class=\"image-aside\" _v-181786a6=\"\">\n  <!-- <div class=\"g-crop-image-box\" > -->\n    <div class=\"g-crop-image-principal\" v-on:touchstart=\"drag\" v-on:mousedown=\"drag\" :style=\"{cursor: isResize ? 'default' : 'move'}\" _v-181786a6=\"\">\n      <div class=\"image-wrap\" :style=\"{ width: width + 'px',height: height + 'px', left: left+ 'px', top: top + 'px', backgroundImage: 'url(' + src + ')'}\" _v-181786a6=\"\">\n        <img ref=\"crop-image\" style=\"width:0;height:0;\" :src=\"src\" _v-181786a6=\"\">\n      </div>\n      <div class=\"image-mask\" v-if=\"!isResize\" _v-181786a6=\"\">\n        <div class=\"mask top\" :style=\"{ top:0, height: cropCSS.top + 'px', left: 0, width: '100%'}\" _v-181786a6=\"\"></div>\n        <div class=\"mask bottom\" :style=\"{ bottom:0, top: (cropCSS.top + cropCSS.height) + 'px', left: 0, width: '100%'}\" _v-181786a6=\"\"></div>\n        <div class=\"mask left\" :style=\"{top: cropCSS.top + 'px', height: cropCSS.height + 'px', left:0, width: cropCSS.left + 'px'}\" _v-181786a6=\"\"></div>\n        <div class=\"mask right\" :style=\"{top: cropCSS.top + 'px', height: cropCSS.height + 'px', left: (cropCSS.left + cropCSS.width) + 'px', right: 0}\" _v-181786a6=\"\"></div>\n      </div>\n      <div class=\"crop-box\" v-if=\"!isResize\" @touchstart.prevent=\"cropMove\" @mousedown.prevent=\"cropMove\" :style=\"{top: cropCSS.top + 'px', left: cropCSS.left + 'px', height: cropCSS.height + 'px',  width: cropCSS.width + 'px'}\" _v-181786a6=\"\">\n        <div class=\"reference-line v\" _v-181786a6=\"\"></div>\n        <div class=\"reference-line h\" _v-181786a6=\"\"></div>\n        <a class=\"g-resize\" v-on:touchstart.self=\"resize\" v-on:mousedown.self=\"resize\" _v-181786a6=\"\"></a>\n      </div>\n    </div>\n    <rotate-bar v-if=\"isRotate\" @rotate=\"rotateImage\" _v-181786a6=\"\"></rotate-bar>\n <!--  </div> -->\n</div>\n";

/***/ }),
/* 102 */
/***/ (function(module, exports) {

module.exports = "\n<div class=\"g-resize-bar\" _v-dd2ece52=\"\">\n  <div class=\"g-resize-highlight\" :style=\"{width: left + '%',}\" _v-dd2ece52=\"\"></div>\n  <button class=\"circle-btn\" @touchstart.self=\"drag\" @mousedown.self=\"drag\" :style=\"{left: left + '%',}\" _v-dd2ece52=\"\"></button>\n</div>\n";
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), false)
  if (!hotAPI.compatible) return
  var id = "_v-ed4b7b04/rotate-bar.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), false)
  if (!hotAPI.compatible) return
  var id = "_v-27a33e4d/vue-core-image-upload.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-181786a6&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./crop.vue", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-181786a6&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./crop.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-dd2ece52&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./resize-bar.vue", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-dd2ece52&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./resize-bar.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
